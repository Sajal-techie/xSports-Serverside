    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_trial', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='playersintrial', to='selection_trial.playersintrial')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='academy', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='trial',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trial', to='selection_trial.trial'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trial', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trial_detials', to='selection_trial.trial')),
            ],
            options={
                'abstract': False,
            },
