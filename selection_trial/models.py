...
class Trial(DataBaseModels):
    academy = models.ForeignKey(Users, on_delete=models.CASCADE, related_name="academy",null=True)
...
class TrialRequirement(DataBaseModels):
    trial = models.ForeignKey(Trial, on_delete=models.CASCADE, related_name="additional_requirements",null=True)
...
class PlayersInTrialDetails(DataBaseModels):
    player_trial = models.ForeignKey(PlayersInTrial, on_delete=models.CASCADE, related_name="playersintrial", null=True)
