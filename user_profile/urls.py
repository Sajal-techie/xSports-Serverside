...
urlpatterns = [
    ...
    path('friend_request_accept/<int:pk>', friend_request_accept, name='friend_request_accept'),
    path('friend_request_reject/<int:pk>', friend_request_reject, name='friend_request_reject'),
